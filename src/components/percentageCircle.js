...
export default class PercentageCircle extends Component {
  static propTypes = {
    ...
    bgcolor: PropTypes.string, //Color of remaing percentage
    innerColor: PropTypes.string, //Background color
    radius: PropTypes.number, //Radius of view
    percent: PropTypes.number, //Percentage
    borderWidth: PropTypes.number,
    textStyle: PropTypes.array, //Text style of percentage
    disabled: PropTypes.bool, 
    disabledPercent: PropTypes.bool,//Visible or invisible percentage
  }
    ...
    return (
      <View style={[styles.circle,{
        ...
        <View style={[styles.innerCircle,{
          ...
          {this.props.children || this.props.disabledPercent ? this.props.children :
