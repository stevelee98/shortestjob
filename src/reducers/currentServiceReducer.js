...
export default function (state = initialState, action) {
    switch (action.type) {
        case ActionEvent.GET_SUBSCRIPTION:
        case ActionEvent.GET_UPCOMING:
        ...
        case ActionEvent.COUNT_NEW_NOTIFICATION:
            ...
            break;
        case getActionSuccess(ActionEvent.GET_SUBSCRIPTION):
        case getActionSuccess(ActionEvent.GET_UPCOMING):
