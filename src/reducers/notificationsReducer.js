...
export default function (state = initialState, action) {
    switch (action.type) {
        case ActionEvent.GET_BLOG_POST:
        ...
        case getActionSuccess(ActionEvent.GET_BLOG_POST):
        ...
        case getActionSuccess(ActionEvent.SEARCH_BLOG):
